...
export default function Chat() {
  ...
  const btnClicked2 = () => {
    ...
    comment.innerText = document
      .getElementById("inputWrap")
    ...
    <>
      <Box>
        <div style={headerStyle}>
          <h1>
            A님과 {OrderName} 배달비 {OrderMin} 주문을 작성하세요
          </h1>
        </div>
      </Box>
      <Box>
      ...
      <Box>
        ...
        <div>
          ...
          <div id="inputWrap" style={{ display: `${Visible}` }}>
            <BoardInput label={"댓글"} />
            <button type="button" onClick={btnClicked2}>
              입력
            </button>
          </div>
        </div>
